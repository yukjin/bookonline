...
<head>
<yukjin:deleteBooks booksIndex="${paramValues.books}" cart="${sessionScope.cart}"/>
...
<table>
<tr>
<th>选项</th><th>书名</th><th>封面</th><th>数量</th><th>单价</th><th>总价</th>
</tr>
<yukjin:showCart cart="${sessionScope.cart}"/>
</table>

<table>
<tr>
	<td>
	<span><input type="checkbox" id="chkAll"/>全选</span><span><input type="submit" id="btnUpdate" name="update" value="删除/更新" class="btn"></span>
	</td>
</tr>
</table>
</form>
</fieldset>
<img src="img03.gif" class="clsImg" id="imgTip"/>
         <a href="order.jsp" class="checkout">checkout &gt;</a> </div>
      <div class="clear"></div>
    </div>
    <!--end of left content-->
