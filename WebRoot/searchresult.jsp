...
<div id="wrap">
  ...
  <div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Result</div>
     <yukjin:showBookList showType="hot" bookList="${requestScope.bookList}"/>
      <div class="pagination"> 
      <yukjin:pagination searchContent="${requestScope.bookname}" type="search" currPage="${requestScope.currPage}" pageNum="${requestScope.pageNum}" category="${requestScope.booktype}"/> 
      </div>
     <div class="clear"></div>
    </div>
    <!--end of left content-->
