...
<div id="wrap">
  <div class="header">
    ...
    <div id="menu">
      <ul>
        ...
        <li class="selected"><a href="newbook.do?page=1">new books</a></li>
  ...
  <div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>new books</div>
      <yukjin:showBookList showType="new" bookList="${requestScope.bookList}"/>
      <div class="pagination"> 
      <yukjin:pagination type="new" currPage="${requestScope.currPage}" pageNum="${requestScope.pageNum}" category="${requestScope.booktype}"/> 
      </div>
      <div class="clear"></div>
    </div>
    <!--end of left content-->
